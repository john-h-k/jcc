  ...
  for (int i = 0; i < height; i++) {
    for (int j = 0; j < width; j++) {
      ...
      if (value == 100) {
        ...
        printf("%s%s", red, char_);
      } else if (value > 70) {
        printf("%s%s", l_red, char_);
      } else if (value > 50) {
        printf("%s%s", orange, char_);
      } else if (value > 30) {
        printf("%s%s", yellow, char_);
      } else if (value > 20) {
        printf("%s%s", l_green, char_);
      } else if (value > 10) {
        printf("%s%s", green, char_);
      } else if (value > 5) {
        printf("%s%s", l_cyan, char_);
      } else if (value > 4) {
        printf("%s%s", cyan, char_);
      } else if (value > 3) {
        printf("%s%s", l_blue, char_);
      } else if (value > 2) {
        printf("%s%s", blue, char_);
      } else if (value > 1) {
        printf("%s%s", magenta, char_);
      } else {
        printf("%s%s", l_magenta, char_);
      }
