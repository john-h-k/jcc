...
void rv32i_emit_sltu(struct rv32i_emitter *emitter, const struct rv32i_op sltu);
...
void rv32i_emit_fld(struct rv32i_emitter *emitter, const struct rv32i_load fld);
