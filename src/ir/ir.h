...
enum ir_op_unary_op_ty {
  ...
  IR_OP_UNARY_OP_TY_CLZ,
  IR_OP_UNARY_OP_TY_CTZ,
  IR_OP_UNARY_OP_TY_REV
};
...
enum FLAG_ENUM ir_eliminate_redundant_ops_flags {
...
enum FLAG_ENUM ir_detach_ir_basicblock_flags {
...
struct ir_var_ty_info ir_var_ty_info_op(const struct ir_var_ty *ty);
