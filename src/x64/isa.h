...
#define NEEDS_SIB(reg)                                                         \
  ((reg).ty == X64_REG_TY_R && ((reg).idx % 8) == REG_IDX_SP)
...
#define IMM_BYTES32(imm)                                                       \
  NBYTE((imm), 0), NBYTE((imm), 1), NBYTE((imm), 2), NBYTE((imm), 3)

#define IMM_BYTES64(imm)                                                       \
  NBYTE((imm), 0), NBYTE((imm), 1), NBYTE((imm), 2), NBYTE((imm), 3),          \
      NBYTE((imm), 4), NBYTE((imm), 5), NBYTE((imm), 6), NBYTE((imm), 7),
...
#define DIV_REG32(rhs)                                                         \
  ((struct x64_raw_instr){                                                     \
      .len = 2,                                                                \
      .buff = {U8(0xF7), MODRM(MOD_REG, (size_t)0b110, (rhs).idx % 8)}})

#define DIV_REG64(rhs)                                                         \
  ((struct x64_raw_instr){                                                     \
      .len = 3,                                                                \
      .buff = {                                                                \
          REX(REX_W(rhs), (size_t)0, (size_t)0, (size_t)((rhs).idx >= 8)),     \
          U8(0xF7), MODRM(MOD_REG, (size_t)0b110, (rhs).idx % 8)}})

#define IMULIDIV_REG32(opc, rhs)                                               \
  ((struct x64_raw_instr){                                                     \
      .len = 2,                                                                \
      .buff = {U8(0xF7), MODRM(MOD_REG, (size_t)opc, (rhs).idx % 8)}})
...
#define IMULIDIV_REG64(opc, rhs)                                               \
  ((struct x64_raw_instr){                                                     \
      ...
      .buff = {                                                                \
          REX(REX_W(rhs), (size_t)0, (size_t)0, (size_t)((rhs).idx >= 8)),     \
          U8(0xF7), MODRM(MOD_REG, (size_t)opc, (rhs).idx % 8)}})

#define DIV_REG(rhs) NEEDS_REX((rhs)) ? DIV_REG64((rhs)) : DIV_REG32((rhs))
...
#define MOVSX8_32_NOREX(dest, source)                                          \
  ((struct x64_raw_instr){                                                     \
      .len = 4,                                                                \
      .buff = {0x0F, 0xBE, MODRM(MOD_REG, (dest).idx % 8, (source).idx % 8)}})

#define MOVSX16_32_NOREX(dest, source)                                         \
  ((struct x64_raw_instr){                                                     \
      .len = 4,                                                                \
      .buff = {0x0F, 0xBF, MODRM(MOD_REG, (dest).idx % 8, (source).idx % 8)}})

#define MOVSX8_32(dest, source)                                                \
  NEEDS_REX((source)) || NEEDS_REX((dest)) ? MOVSX8_64((source), (dest))       \
                                           : MOVSX8_32_NOREX((source), (dest))
#define MOVSX16_32(dest, source)                                               \
  NEEDS_REX((source)) || NEEDS_REX((dest))                                     \
      ? MOVSX16_64((source), (dest))                                           \
      : MOVSX16_32_NOREX((source), (dest))
...
#define MOVSX8_64(dest, source)                                                \
  ((struct x64_raw_instr){                                                     \
      ...
      .buff = {REX(REX_W(source), (size_t)((dest).idx > 7), (size_t)0,         \
                   (size_t)((source).idx > 7)),                                \
               0x0F, 0xBE, MODRM(MOD_REG, (dest).idx % 8, (source).idx % 8)}})
...
#define MOVSX16_64(dest, source)                                               \
  ((struct x64_raw_instr){                                                     \
      ...
      .buff = {REX(REX_W(source), (size_t)((dest).idx > 7), (size_t)0,         \
                   (size_t)((source).idx > 7)),                                \
               0x0F, 0xBF, MODRM(MOD_REG, (dest).idx % 8, (source).idx % 8)}})
...
#define MOVSX32_64(dest, source)                                               \
  ((struct x64_raw_instr){                                                     \
      ...
      .buff = {REX(REX_W(source), (size_t)((dest).idx > 7), (size_t)0,         \
                   (size_t)((source).idx > 7)),                                \
               0x63, MODRM(MOD_REG, (dest).idx % 8, (source).idx % 8)}})

#define ALU_IMM32(opc0, opc1, dest, imm)                                       \
  ((struct x64_raw_instr){.len = 6,                                            \
                          .buff = {(opc0),                                     \
                                   MODRM(MOD_REG, (size_t)(opc1), (dest).idx), \
                                   IMM_BYTES32((imm))}})

#define ALU_IMM32_REX(opc0, opc1, dest, imm)                                   \
  ((struct x64_raw_instr){                                                     \
      .len = 7,                                                                \
      .buff = {REX((size_t)0, (size_t)0, (size_t)0, (size_t)((dest).idx > 7)), \
...
#define ALU_IMM64_REX(opc0, opc1, dest, imm)                                   \
  ((struct x64_raw_instr){                                                     \
      ...
      .buff = {REX((size_t)1, (size_t)0, (size_t)0, (size_t)((dest).idx > 7)), \
               (opc0), MODRM(MOD_REG, (opc1), (dest).idx % 8),                 \
               IMM_BYTES32(imm)}})
...
#define MOV_MEM_IMM(opc, reg, addr, imm)                                       \
  ((NEEDS_SIB(addr)) ? MOV_MEM_IMM_SIB((opc), (reg), (addr), (imm))            \
                     : MOV_MEM_IMM_NOSIB((opc), (reg), (addr), (imm)))
...
#define MOV_MEM16_IMM32(opc, reg, addr, imm)                                   \
  ((struct x64_raw_instr){                                                     \
      .len = 7,                                                                \
      .buff = {0x66, (opc),                                                    \
               MODRM(MOD_RM_IMM32, (reg).idx % 8, (addr).idx % 8),             \
               IMM_BYTES32((imm))}})
...
#define MOV_MEM16_IMM8_REX(opc, reg, addr, imm)                                \
  ((struct x64_raw_instr){                                                     \
      .len = 5,                                                                \
      .buff = {0x66,                                                           \
               REX(REX_W(reg), (size_t)((reg).idx > 7), (size_t)0,             \
                   (size_t)((addr).idx > 7)),                                  \
               (opc), MODRM(MOD_RM_IMM8, (reg).idx % 8, (addr).idx % 8),       \
               IMM_BYTES8((imm))}})
...
#define MOV_MEM16_IMM(opc, reg, addr, imm)                                     \
  ((NEEDS_SIB(addr)) ? MOV_MEM16_IMM_SIB((opc), (reg), (addr), (imm))          \
                     : MOV_MEM16_IMM_NOSIB((opc), (reg), (addr), (imm)))
...
#define JMP_REG_BASE(reg)                                                      \
  ((struct x64_raw_instr){                                                     \
      .len = 2, .buff = {0xFF, MODRM(MOD_RM_MEM, (size_t)0b100, (reg).idx)}})
#define JMP_REG_REX(reg)                                                       \
  ((struct x64_raw_instr){                                                     \
      .len = 3,                                                                \
      .buff = {REX_PREFIX(1, 0, 0, 1), 0xFF,                                   \
               MODRM(MOD_RM_MEM, (size_t)0b100, (reg).idx % 8)}})

#define JMP_REG(reg) (reg).idx < 8 ? JMP_REG_BASE((reg)) : JMP_REG_REX((reg))

#define JMP_COND_REL8(cc, disp)                                                \
  ((struct x64_raw_instr){.len = 2, .buff = {0x70 + U8(cc), IMM_BYTES8(disp)}})
...
#define SET_COND(cc, dest)                                                     \
  ((dest).idx < 4                                                              \
       ? ((struct x64_raw_instr){                                              \
             .len = 3,                                                         \
             .buff = {0x0F, 0x90 + U8(cc),                                     \
                      MODRM(MOD_REG, (size_t)0, (size_t)((dest).idx))}})       \
       : ((struct x64_raw_instr){                                              \
             .len = 4,                                                         \
...
#define PUSH_REG64(reg)                                                        \
  (reg).idx < 8                                                                \
      ? ((struct x64_raw_instr){.len = 1, .buff = {0x50 + U8((reg).idx)}})     \
      : ((struct x64_raw_instr){.len = 2,                                      \
                                .buff = {0x41, 0x50 + U8((reg).idx)}})

#define POP_REG64(reg)                                                         \
  (reg).idx < 8                                                                \
      ? ((struct x64_raw_instr){.len = 1, .buff = {0x58 + U8((reg).idx)}})     \
      : ((struct x64_raw_instr){.len = 2,                                      \
...
#define TEST_REG(lhs, rhs)                                                     \
  (NEEDS_REX((lhs)) || NEEDS_REX((rhs))                                        \
       ? ((struct x64_raw_instr){                                              \
             .len = 3,                                                         \
             .buff = {REX(REX_W(lhs), (size_t)((rhs).idx > 7), (size_t)0,      \
                          (size_t)((lhs).idx > 7)),                            \
                      0x85, MODRM(MOD_REG, (rhs).idx % 8, (lhs).idx % 8)}})    \
       : ((struct x64_raw_instr){                                              \
             .len = 2, .buff = {0x85, MODRM(MOD_REG, (rhs).idx, (lhs).idx)}}))
...
#define CMP_REG(lhs, rhs)                                                      \
  (NEEDS_REX((lhs)) || NEEDS_REX((rhs))                                        \
       ? ((struct x64_raw_instr){                                              \
             .len = 3,                                                         \
             .buff = {REX(REX_W(lhs), (size_t)((lhs).idx > 7), (size_t)0,      \
                          (size_t)((rhs).idx > 7)),                            \
                      0x3B, MODRM(MOD_REG, (lhs).idx % 8, (rhs).idx % 8)}})    \
       : ((struct x64_raw_instr){                                              \
             .len = 2, .buff = {0x3B, MODRM(MOD_REG, (lhs).idx, (rhs).idx)}}))

#define CALL_REL32(disp)                                                       \
  ((struct x64_raw_instr){.len = 5, .buff = {0xE8, IMM_BYTES32((disp))}})
...
#define LEA_PCREL(dest, offset)                                                \
  ((struct x64_raw_instr){                                                     \
      .len = 7,                                                                \
      .buff = {REX((size_t)1, (size_t)((dest.idx) > 7), (size_t)0, (size_t)0), \
               0x8D, MODRM(MOD_RM_MEM, ((dest).idx % 8), (size_t)0b101),       \
               IMM_BYTES32(offset)}})
...
#define LEA_REG64_IMM0(dest, index, base, scale, offset)                       \
  ((struct x64_raw_instr){                                                     \
      .len = 4,                                                                \
      .buff = {REX((size_t)1, (size_t)((dest).idx > 7),                        \
                   (size_t)((index).idx > 7), (size_t)((base).idx > 7)),       \
               0x8D, MODRM(MOD_RM_MEM, ((dest).idx % 8), (size_t)0b100),       \
...
#define LEA_REG64_IMM8(dest, index, base, scale, offset)                       \
  ((struct x64_raw_instr){                                                     \
      ...
      .buff = {REX((size_t)1, (size_t)((dest).idx > 7),                        \
                   (size_t)((index).idx > 7), (size_t)((base).idx > 7)),       \
               0x8D, MODRM(MOD_RM_IMM8, ((dest).idx % 8), (size_t)0b100),      \
               SIB(scale, ((index).idx % 8), ((base).idx % 8)),                \
               IMM_BYTES8(offset)}})
...
#define LEA_REG64_IMM32(dest, index, base, scale, offset)                      \
  ((struct x64_raw_instr){                                                     \
      ...
      .buff = {REX((size_t)1, (size_t)((dest).idx > 7),                        \
                   (size_t)((index).idx > 7), (size_t)((base).idx > 7)),       \
               0x8D, MODRM(MOD_RM_IMM32, ((dest).idx % 8), (size_t)0b100),     \
               SIB(scale, ((index).idx % 8), ((base).idx % 8)),                \
               IMM_BYTES32(offset)}})
...
#define LEA_NOIDX_REG64_IMM8(dest, base, offset)                               \
  ((struct x64_raw_instr){                                                     \
      .len = 4,                                                                \
      .buff = {REX((size_t)1, (size_t)((dest).idx > 7), (size_t)0,             \
                   (size_t)((base).idx > 7)),                                  \
               0x8D, MODRM(MOD_RM_IMM8, ((dest).idx % 8), ((base).idx % 8)),   \
               IMM_BYTES8(offset)}})
...
#define LEA_NOIDX_REG64_IMM32(dest, base, offset)                              \
  ((struct x64_raw_instr){                                                     \
      ...
      .buff = {REX((size_t)1, (size_t)((dest).idx > 7), (size_t)0,             \
                   (size_t)((base).idx > 7)),                                  \
               0x8D, MODRM(MOD_RM_IMM32, ((dest).idx % 8), ((base).idx % 8)),  \
               IMM_BYTES32(offset)}})
...
#define MOV_LOAD_SS(dest, source, imm)                                         \
  SSE_INSTR_NON_PS_MEM_IMM32(0x10, SCALAR_SINGLE, (dest), (source), (imm))
#define MOV_STORE_SS(dest, source, imm)                                        \
  SSE_INSTR_NON_PS_MEM_IMM32(0x11, SCALAR_SINGLE, (dest), (source), (imm))
#define MOV_LOAD_SD(dest, source, imm)                                         \
  SSE_INSTR_NON_PS_MEM_IMM32(0x10, SCALAR_DOUBLE, (dest), (source), (imm))
#define MOV_STORE_SD(dest, source, imm)                                        \
  SSE_INSTR_NON_PS_MEM_IMM32(0x11, SCALAR_DOUBLE, (dest), (source), (imm))

#define MOVAPS(dest, source) SSE_INSTR_PS(0x28, (dest), (source))
#define MOVAPD(dest, source)                                                   \
  SSE_INSTR_NON_PS(0x28, PACKED_DOUBLE, (dest), (source))
...
#define ANDPD(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x54, PACKED_DOUBLE, (dest), (source))
#define ORPD(dest, source)                                                     \
  SSE_INSTR_NON_PS(0x56, PACKED_DOUBLE, (dest), (source))
#define XORPD(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x57, PACKED_DOUBLE, (dest), (source))

#define UCOMISS(dest, source) SSE_INSTR_PS(0x2E, (dest), (source))
#define UCOMISD(dest, source)                                                  \
  SSE_INSTR_NON_PS(0x2E, PACKED_DOUBLE, (dest), (source))

#define SQRTSS(dest, source)                                                   \
  SSE_INSTR_NON_PS(0x51, SCALAR_SINGLE, (dest), (source))
#define SQRTSD(dest, source)                                                   \
  SSE_INSTR_NON_PS(0x51, SCALAR_DOUBLE, (dest), (source))

#define ADDSS(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x58, SCALAR_SINGLE, (dest), (source))
#define ADDSD(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x58, SCALAR_DOUBLE, (dest), (source))

#define SUBSS(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x5C, SCALAR_SINGLE, (dest), (source))
#define SUBSD(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x5C, SCALAR_DOUBLE, (dest), (source))

#define MULSS(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x59, SCALAR_SINGLE, (dest), (source))
#define MULSD(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x59, SCALAR_DOUBLE, (dest), (source))

#define DIVSS(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x5E, SCALAR_SINGLE, (dest), (source))
#define DIVSD(dest, source)                                                    \
  SSE_INSTR_NON_PS(0x5E, SCALAR_DOUBLE, (dest), (source))

#define CVTSI2SS(dest, source)                                                 \
  SSE_INSTR_NON_PS(0x2A, SCALAR_SINGLE, (dest), (source))
#define CVTSI2SD(dest, source)                                                 \
  SSE_INSTR_NON_PS(0x2A, SCALAR_DOUBLE, (dest), (source))

#define CVTSS2SI(dest, source)                                                 \
  SSE_INSTR_NON_PS(0x2D, SCALAR_SINGLE, (dest), (source))
#define CVTSD2SI(dest, source)                                                 \
  SSE_INSTR_NON_PS(0x2D, SCALAR_DOUBLE, (dest), (source))

#define CVTTSS2SI(dest, source)                                                \
  SSE_INSTR_NON_PS(0x2C, SCALAR_SINGLE, (dest), (source))
#define CVTTSD2SI(dest, source)                                                \
  SSE_INSTR_NON_PS(0x2C, SCALAR_DOUBLE, (dest), (source))

#define CVTSS2SD(dest, source)                                                 \
  SSE_INSTR_NON_PS(0x5A, SCALAR_SINGLE, (dest), (source))
#define CVTSD2SS(dest, source)                                                 \
  SSE_INSTR_NON_PS(0x5A, SCALAR_DOUBLE, (dest), (source))
